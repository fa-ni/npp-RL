...
def test_step(set_up):
    ...
    np.testing.assert_almost_equal(
        actual_step_one[0],
        np.array([-1, 0.0005, -1, -0.00025, -1, 1]),
    )
    np.testing.assert_almost_equal(
        actual_step_two[0],
        np.array([-1, 0.0, -0.99868, -0.00036, -1, 1]),
        5,
    )
    np.testing.assert_almost_equal(
        actual_step_three[0], np.array([-0.995, -0.00089, -0.99611, -0.00064, -0.99980, 1]), 5
    )
...
def test_reset(set_up):
    ...
    assert all(actual == np.array([-1, 0, -1, 0, -1, 1]))

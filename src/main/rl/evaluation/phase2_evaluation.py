...
all_files = []
# TODO change path
for file in glob.glob("../models/models/scenario2/*/*/*.zip", recursive=True):
    all_files.append(file)
# Check if all models have been found
# assert len(files_without_automation) == 1200
# assert len(files_with_automation) == 1200
...
for path in all_files:
    ...
    result_dict["combination"] = path[:-17]
